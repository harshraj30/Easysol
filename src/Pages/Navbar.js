        ...
        <div className="w-screen flex justify-center bg-gray-200 shadow-lg shadow-gray-500 fixed z-50 top-0 py-3">
            <div className="w-[80%] flex justify-between items-center">
                ...
                <div className="flex items-center gap-7 text-rose-700 ">
                    <Link><p className='border px-5 py-2.5 text-rose-500 border-rose-500'>Home</p></Link>
                        ...
                        <div className="group">
                            ...
                            <div className="absolute z-20 hidden group-hover:block -ml-16 mt-2 shadow-xl">
                                ...
                                <div className="pt-4 flex -mt-[10px] border bg-white flex-col text-md font-semibold">
                                    <Link className='hover:bg-gray-100 bg-white p-5  ' href="">
                                        <div className="">
                                            ...
                                            <div className="absolute z-20 hidden group-hover:block ml-60 -mt-20 shadow-xl">
                                                <div className="w-64 h-3 -mt-3"></div>
                                                <div className=" w-4 h-6"></div>
                                                <div className="pt-4 flex border bg-white flex-col text-md font-semibold">
                                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >Warehouses</Link>
                                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >C & F</Link>
                                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >Distributers</Link>
                                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >Retail Chain</Link>
                                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >Chemist</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </Link>
                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >EasySol POS</Link>
                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >Departmental Store Software</Link>
                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >Grocery Store Software</Link>
                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >Retail/ General Store</Link>
                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >EasySol Manufacturing</Link>
                                    <Link className='hover:bg-gray-100 bg-white p-5 ' >EasySol Trading</Link>
                                </div>
                            </div>
                        </div>
